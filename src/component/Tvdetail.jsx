...
const Tvdetail = () => {
    ...
    const navigate=useNavigate();
      ...
      return info ?(
        ...
        className=' relative w-screen h-[230vh] px-[10%] overflow-hidden '>
          ...
          <img className=' bg-zinc-300  w-[50vh] bg-center rounded h-[43vh]  object-cover  ' src={ `https://image.tmdb.org/t/p/original/${ info.detail.poster_path||info.detail.backdrop_path}`} alt='' />
            ...
            <div className='content ml-[5%] text-white'>
               ...
               <div className='mt-3 mb-5 flex text-white items-center gap-x-5'>
                 ...
                 <h1 className='text-2xl mt-2'>Translations</h1>
   ...
   className='w-[7vh] h-[7vh] object-cover rounded-md'
    src={ `https://image.tmdb.org/t/p/original/${ w.logo_path}`} alt='' />
         ...
         <hr className='mt-5 mb-5 border-none h-[1px] bg-zinc-500'></hr>
         ...
         <div className='w-[100%] flex overflow-y-hidden  mb-5  p-5'>
          {info.detail.seasons.length>0?info.detail.seasons.map((s,i) =>(
           <div className='w-[15vh] mr-[12%]'>
            <img className=' bg-zinc-300 min-w-[14vw] rounded h-[40vh]  object-cover  ' src={ `https://image.tmdb.org/t/p/original/${s.backdrop_path || s.poster_path||s.profile_path}`} alt='' />
           
            <h1 className='text-2xl text-zinc-200 mt-3 font semibold  '>{s.name}
            </h1>
